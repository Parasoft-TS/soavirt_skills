...
2. For URL mode, probe the exact XSD URL and expect `200` from server runtime.
3. Confirm content matches endpoint expectation (XSD for this skill).
...
- Runtime validated with external XSD source.
- Evidence:
  - `work/runs/2026-03-03/tst-current/db-tool-root-traffic-run/skill25_create_xsd_tst_request.json`
  - `work/runs/2026-03-03/tst-current/db-tool-root-traffic-run/skill25_create_xsd_tst_response.json`
  - `work/runs/2026-03-03/tst-current/db-tool-root-traffic-run/skill25_delete_xsd_tst_response.json`
